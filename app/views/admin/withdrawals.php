                            ...
                            <?php else: ?>
                                <?php foreach ($requests as $request): ?>
                                    <tr class="border-b border-slate-100">
                                        ...
                                        <td class="p-3">XAF <?= number_format((float)$request['amount'], 2) ?></td>
                                        <td class="p-3">XAF <?= number_format((float)$request['fee'], 2) ?></td>
                                        <td class="p-3">XAF <?= number_format((float)$request['net_amount'], 2) ?></td>
