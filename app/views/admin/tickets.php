        ...
        <div class="bg-white border-b border-slate-200 px-6 py-4 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 sticky top-0 z-10">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500">Review help center requests.</p>
                </div>
            </div>
            <div class="flex items-center space-x-3">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <?php if (empty($tickets)): ?>
                                <tr>
                                    <td colspan="4" class="p-6 text-center text-slate-500">No tickets yet.</td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($tickets as $ticket): ?>
                                    <tr class="border-b border-slate-100">
                                        <td class="p-3">
                                            ...
                                            <div class="text-xs text-slate-500"><?= htmlspecialchars($ticket['email'] ?? '') ?></div>
                                        </td>
                                        <td class="p-3">
                                            <div class="font-medium"><?= htmlspecialchars($ticket['subject']) ?></div>
                                            <div class="text-xs text-slate-500"><?= htmlspecialchars($ticket['message']) ?></div>
                                        </td>
